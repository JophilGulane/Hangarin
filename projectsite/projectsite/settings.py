...
SECRET_KEY = 'django-insecure-*ib__k4^x*45sus+*wkjtm#1z2ghqvqhgot$lnejcylvik)j1!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'jayshangarin.pythonanywhere.com']
...
DATABASES = {
    "default": {
        ...
        "NAME": "/home/jayshangarin/hangarinenv/Hangarin/projectsite/db.sqlite3",
    }
}
...
PWA_APP_ICONS = [
{
'src': '/static/img/logo_192x192.png',
'sizes': '192x192'
},
{
'src': '/static/img/logo_512x512.png',
'sizes': '512x512'
}
]
PWA_APP_ICONS_APPLE = [
